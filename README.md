...
I built an artist [Tableau Dashboard](https://public.tableau.com/app/profile/kovenda/viz/ViewsonYouTubefor___/Dashboard2), data pulled from youtube using Youtube API and Youtube Analytics API and stored in PostgreSQL database on AWS-RDS
